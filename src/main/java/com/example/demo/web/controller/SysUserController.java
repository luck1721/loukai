...
public class SysUserController extends ApiController {
	 ...
	 */
	@GetMapping
	public R selectAll(PageParam pageParam, SysUser sysUser) {
		QueryPage queryPage = CommonQueryPageUtils.commonQueryPage(pageParam, null);
		return success(this.sysUserService.page(queryPage.getPage(), new QueryWrapper<>(sysUser)));
	}
